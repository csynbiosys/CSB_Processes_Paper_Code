...
%     global_theta_max = [0.4950,0.4950,4.9,10,0.23,6.8067,0.2449,0.0217,1e2];
    ...
    global_theta_min = [3.88e-5,3.88e-2,0.5,2,0.01,0.1,5e-5,0.012,1];
    ...
    global_theta_guess = [A(1),A(2),1.7547,5.5954,G(5),A(6),6.1197e-04,A(8),A(9)]';
...
%     inputs.nlpsol.DE.cvarmax = 1e-6;
    ...
    inputs.nlpsol.eSS.log_var = [3,4,5,7,9];
