...
%inputs.pathd.runident='20stepf';                   % Run identifieer
%======================
% MODEL RELATED DATA
%======================
...
c1 = 100; c2 = 0.51; c3 = 4.0; u2=0;
inputs.model.par=[c1 c2 c3 u2];
...
% INITIAL CONDITIONS TO BE OPTIMISED
 ...
 inputs.DOsol.par_min= [0 ];                                       % Minimum allowed values for the paramters/ sustained controls
 inputs.DOsol.par_guess= [0.25 ]; 
