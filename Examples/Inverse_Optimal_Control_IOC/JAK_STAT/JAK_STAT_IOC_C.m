...
inputs.pathd.short_name='JSC';                % To identify figures and reports for a given problem   
...
inputs.nlpsol.eSS.local.solver='dhc';      % Choose local solver
...
inputs.nlpsol.eSS.maxtime = 100; % iteratively increased in the run m.file %%% CHECKING conv curves to make sure is enough in every iteration
