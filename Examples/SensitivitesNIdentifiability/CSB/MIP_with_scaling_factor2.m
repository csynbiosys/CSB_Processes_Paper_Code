% As the experimental data is acquired in A.U., we add an additional state
% to the model and convert from molecule number to A.U. using an additional parameter
% sc_molec. 
...
model.par = [0.0164186333380725 0.291556643109224 1.71763487775568 5.14394334860864 0.229999999999978 6.63776658557266 0.00575139649497780 0.0216999999961899 68.8669567134881]; % The parameter vector is set to the best estimates for MIP,r