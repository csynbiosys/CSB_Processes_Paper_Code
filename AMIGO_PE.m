function [results, inputs, privstruct]=AMIGO_PE(input_file,run_ident,opt_solver,opts_solver)
% AMIGO_PE: performs model unknowns estimation
%
%******************************************************************************
% AMIGO2: dynamic modeling, optimization and control of biological systems    %
% AMIGO_PE code development: Eva Balsa-Canto, David Henriques, Attila Gábor   %
...
%*****************************************************************************%
% $Header: svn://.../trunk/AMIGO2R2016/AMIGO_PE.m 2487 2016-02-23 14:01:49Z evabalsa $
% close all;
...
%Reads inputs
[inputs]=AMIGO_check_model(input_file,inputs_def);
...
if privstruct.ntotal_constraints >0
    [results,inputs]=AMIGO_gen_PEconstraints(inputs,privstruct);
end
