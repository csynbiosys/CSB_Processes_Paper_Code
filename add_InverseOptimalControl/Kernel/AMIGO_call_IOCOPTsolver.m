...
% AMIGO_call_ODOPTsolver:  Calls the optimization solver selected by user for OD 
        ...
        case 'de'
            ...
            AMIGO_report_guess_bounds(vguess,vmin,vmax,inputs.pathd.report);  
                ...
                cost_function=inputs.pathd.ioc_function;
        ...
        case 'sres'
         ...
         case 'ssm'
            ...
            problem.f=inputs.pathd.ioc_function;    
            eval(sprintf('%s',inputs.pathd.ioc_constraints))
      ...
      case {'ess','eSS'}           
         ...
         case 'monlot'
            ...
            inputs.nlpsol.nlp_opts.nobjs=inputs.iocsol.N_DOcost;
            inputs.nlpsol.nlp_opts.fun=inputs.pathd.ioc_function; 
...
%             end
            ...
            inputs.nlpsol.nsga2.numObj=inputs.iocsol.N_DOcost;
            inputs.nlpsol.nsga2.numCons=results.nlpsol.ntotalconstraints;
            inputs.nlpsol.nsga2.objfun=inputs.pathd.ioc_function;     
            inputs.nlpsol.nsga2.nameObj=inputs.iocsol.ioccost;
