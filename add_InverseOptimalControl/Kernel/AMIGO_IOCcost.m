  ...
  switch inputs.IOCsol.ioccost_type   
    ...
    f=nf;
            ...
            if inputs.model.alpha>0 || inputs.model.beta>0
                   ...
                   f=nf+inputs.model.beta*reg_par;
                   ...
                   inputs.IOCsol.u_ref{iexp}=inputs.IOCsol.u_guess{iexp};
                    ...
                    f=f+inputs.model.alpha*reg_u/inputs.model.n_stimulus/privstruct.t_con{iexp}(end);
            ...
            f=f+inputs.IOCsol.smoothing*penalty_noisy_u; % penalty on the number of elments contributing to noisy profiles
...
%                 pause
               ...
               f=f+inputs.IOCsol.uttReg*penalty_uttReg; 
            end
