...
function [inputs,privstruct]= AMIGO_check_IOC(input_file,inputs_def)
...
%
    ...
    inputs.exps.u{iexp}=inputs.IOCsol.u_guess{iexp};
    inputs.exps.u_max{iexp}=inputs.IOCsol.u_max{iexp};
    inputs.exps.u_min{iexp}=inputs.IOCsol.u_min{iexp};
    inputs.exps.t_con{iexp}= inputs.IOCsol.t_con{iexp};     
    inputs.exps.u_interp{iexp}=inputs.IOCsol.u_interp;
    inputs.exps.n_pulses{iexp}=inputs.IOCsol.n_pulses{iexp};
    inputs.exps.n_steps{iexp}=inputs.IOCsol.n_steps{iexp};
    inputs.exps.n_linear{iexp}=inputs.IOCsol.n_linear{iexp};
