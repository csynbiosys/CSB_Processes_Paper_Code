...
%                     end
    ...
    case 'real'
        ...
        if strcmp(inputs.IOCsol.ioccost_type,'llk')
            ...
            if (strcmp(inputs.IOCsol.llk_type,'homo') || strcmp(inputs.IOCsol.llk_type,'homo_var')) 
...
if ~isfield(inputs.IOCsol,'ioccost_type') || isempty(inputs.IOCsol.ioccost_type)
    inputs.IOCsol.ioccost_type='lsq';
    fprintf(1,'\n\n------> WARNING message\n\n');
